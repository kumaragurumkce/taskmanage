<template>
  <div class="container-fluid">
    <h1 class="text-center">{{ $t('Task Management') }}</h1>
    <div class="row justify-content-center">
      <div class="col-lg-6 col-12 col-md-8 col-xxl-6">
        <form @submit.prevent="submitForm">
          <div class="d-flex gap-2 justify-content-between align-item-center">
...
export default {
  ...
  if (!this.newTaskTitle || this.newTaskTitle.trim() === '') { // Safely check if newTaskTitle is not undefined or empty
    this.titleError = this.$t('AddInputError');
    this.isValid = false;
  } else {
    this.titleError = '';
    this.isValid = true;
